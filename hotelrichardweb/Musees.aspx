<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMenu.master" AutoEventWireup="true" CodeBehind="Musees.aspx.cs" Inherits="hotelrichardweb.Musees" %>
...
<asp:DataList ID="DataList1" runat="server" EnableViewState = "true" 
    ...
    <asp:SqlDataSource ID="datasource" runat="server"
          SelectCommand="SELECT Name, description, pahh FROM Sites where typesite='Musees'"  
          >
    <SelectParameters>
