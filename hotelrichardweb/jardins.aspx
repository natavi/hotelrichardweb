<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMenu.master" AutoEventWireup="true" CodeBehind="parcsaffaires.aspx.cs" Inherits="hotelrichardweb.jardins" %>
...
<asp:DataList ID="DataList1" runat="server" EnableViewState = "true" 
    ...
    <asp:SqlDataSource ID="datasource" runat="server"
          SelectCommand="SELECT Name, description, path FROM Sites where typesite='jardin'"  
          >
    <SelectParameters>
